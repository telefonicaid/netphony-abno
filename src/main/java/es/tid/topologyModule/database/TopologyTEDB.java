...
public interface TopologyTEDB 
{
	...
	public void register(String id, ComputingAlgorithmPreComputation compAlgPreComp);
	public void registerSSON(String id, ComputingAlgorithmPreComputationSSON compAlgPreComp);
