...
import es.tid.topologyModuleBase.COPServiceTopology.client.auth.ApiKeyAuth;
import es.tid.topologyModuleBase.COPServiceTopology.client.auth.Authentication;
import es.tid.topologyModuleBase.COPServiceTopology.client.auth.HttpBasicAuth;
import es.tid.topologyModuleBase.COPServiceTopology.client.auth.OAuth;
...
public class ApiClient {
  ...
  private String basePath = "http://localhost:8080/restconf";
