...
public class TopologyModuleMessageTypes {
	...
	/**
	 * OPERATION_FOR_INFORMATION_RETRIEVER_CLASS
	 * Get node by interface address
	 */
	public static final int GET_NODE_BY_INTF_ADDRESS_OP = 7;
	/**
	 * OPERATION_FOR_INFORMATION_RETRIEVER_CLASS
	 * Get node by interface name
	 */
	public static final int GET_NODE_BY_INTF_NAME_OP = 8;
	/**
	 * OPERATION_FOR_INFORMATION_RETRIEVER_CLASS
	 * Get interface by interface address
	 */
	public static final int GET_INTF_BY_ADDRESS_OP = 9;
	/**
	 * OPERATION_FOR_INFORMATION_RETRIEVER_CLASS
	 * Get node by managemenet address
	 */
	public static final int GET_NODE_BY_ADDRESS_OP = 10;
	/**
